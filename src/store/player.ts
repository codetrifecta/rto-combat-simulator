...
export const usePlayerStore = create<IPlayerStore>((set, get) => ({
  ...
  getPlayer: () => {
    const player: IPlayer = {
      ...
      spritesheet_rows: get().spritesheet_rows,
      spritesheet_columns: get().spritesheet_columns,
      spritesheet_idle_row: get().spritesheet_idle_row,
      spritesheet_movement_row: get().spritesheet_movement_row,
      spritesheet_attack_row: get().spritesheet_attack_row,
      spritesheet_damaged_row: get().spritesheet_damaged_row,
      spritesheet_defeat_row: get().spritesheet_defeat_row,
