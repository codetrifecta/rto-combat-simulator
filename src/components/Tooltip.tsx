...
export const Tooltip: FC<{ children: ReactNode; active?: boolean }> = ({
  ...
  return (
    <div
      className={clsx(
        "absolute inline-block bg-neutral-900 text-white p-2 rounded-lg shadow-lg transition-all ease duration-200 w-[300px] opacity-0 peer-hover:opacity-100 peer-hover:z-50"
      )}
      ref={ref}
    >
      {children}
